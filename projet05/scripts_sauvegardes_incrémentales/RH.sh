#########################################################################
#Titre: Script de sauvegarde incrémentale pour arborescence "RH"        #
...
DATE="$(date '+%F-%T')"
SEMAINE="$(date '+%G-%V-\(%T\)')"
COUNT_FILE="/home/lucas/compteurs/compteur_RH"

#Définition Source:
SRC_PATH="/home/lucas/A_SAUVEGARDER/RH/" 

#Définition Destination:
DST_HOST="srv-stockage"
DST_USER="user-backup"
DST_SAVE_PATH="/home/user-backup/Sauvegardes/RH"
DST_ARCHIVAGE_PATH="/home/user-backup/Archivage/RH"

#Préparation Log
LOG_DIR="/home/lucas/saves.log/RH"
mkdir -p $LOG_DIR
LOG_FILE="${LOG_DIR}/backup_RH_${DATE}.log"
...
ssh "${DST_USER}@${DST_HOST}" "find ${DST_ARCHIVAGE_PATH} -mindepth 1 -maxdepth 1 -type d -mtime +28 -exec rm -rf {} \;"
