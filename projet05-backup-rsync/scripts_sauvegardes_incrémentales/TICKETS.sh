#########################################################################
#Titre: Script de sauvegarde incrémentale pour arborescence "TICKETS"   #
...
DATE="$(date '+%F-%T')"
SEMAINE="$(date '+%G-%V-\(%T\)')"
COUNT_FILE="/home/lucas/compteurs/compteur_TICKETS"

#Définition Source:
SRC_PATH="/home/lucas/A_SAUVEGARDER/TICKETS/" 

#Définition Destination:
DST_HOST="srv-stockage"
DST_USER="user-backup"
DST_SAVE_PATH="/home/user-backup/Sauvegardes/TICKETS"
DST_ARCHIVAGE_PATH="/home/user-backup/Archivage/TICKETS"

#Préparation Log
LOG_DIR="/home/lucas/saves.log/TICKETS"
mkdir -p $LOG_DIR
LOG_FILE="${LOG_DIR}/backup_TICKETS_${DATE}.log"
