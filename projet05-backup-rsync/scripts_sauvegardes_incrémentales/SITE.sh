#########################################################################
#Titre: Script de sauvegarde incrémentale pour arborescence "SITE"      #
...
DATE="$(date '+%F-%T')"
SEMAINE="$(date '+%G-%V-\(%T\)')"
COUNT_FILE="/home/lucas/compteurs/compteur_SITE"

#Définition Source:
SRC_PATH="/home/lucas/A_SAUVEGARDER/SITE/" 

#Définition Destination:
DST_HOST="srv-stockage"
DST_USER="user-backup"
DST_SAVE_PATH="/home/user-backup/Sauvegardes/SITE"
DST_ARCHIVAGE_PATH="/home/user-backup/Archivage/SITE"

#Préparation Log
LOG_DIR="/home/lucas/saves.log/SITE"
mkdir -p $LOG_DIR
LOG_FILE="${LOG_DIR}/backup_SITE_${DATE}.log"
...
ssh "${DST_USER}@${DST_HOST}" "find ${DST_ARCHIVAGE_PATH} -mindepth 1 -maxdepth 1 -type d -mtime +21 -exec rm -rf {} \;"
