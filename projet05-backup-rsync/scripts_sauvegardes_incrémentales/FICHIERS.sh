#########################################################################
#Titre: Script de sauvegarde incrémentale pour arborescence "FICHIERS"  #
...
DATE="$(date '+%F-%T')"
SEMAINE="$(date '+%G-%V-\(%T\)')"
COUNT_FILE="/home/lucas/compteurs/compteur_FICHIERS"

#Définition Source:
SRC_PATH="/home/lucas/A_SAUVEGARDER/FICHIERS/" 

#Définition Destination:
DST_HOST="srv-stockage"
DST_USER="user-backup"
DST_SAVE_PATH="/home/user-backup/Sauvegardes/FICHIERS"
DST_ARCHIVAGE_PATH="/home/user-backup/Archivage/FICHIERS"

#Préparation Log
LOG_DIR="/home/lucas/saves.log/FICHIERS"
mkdir -p $LOG_DIR
LOG_FILE="${LOG_DIR}/backup_FICHIERS_${DATE}.log"
